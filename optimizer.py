...
def optimize_tes_plant(df_24h: pd.DataFrame, scope: str, peak_tr: float, audit_config: dict, rates: dict):
    base_sim = simulate_24h_plant(df_24h, scope, audit_config, total_fleet_tr=peak_tr)
